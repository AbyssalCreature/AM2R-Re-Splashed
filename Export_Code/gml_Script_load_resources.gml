...
if file_exists("mods/palettes/monsters/alpha.png")
    AlphaPalette = sprite_add("mods/palettes/monsters/alpha.png", 1, false, false, 0, 0)
if file_exists("mods/palettes/monsters/gamma.png")
    GammaPalette = sprite_add("mods/palettes/monsters/gamma.png", 1, false, false, 0, 0)
if file_exists("mods/palettes/monsters/zeta.png")
    ZetaPalette = sprite_add("mods/palettes/monsters/zeta.png", 1, false, false, 0, 0)
if file_exists("mods/palettes/monsters/omega.png")
    OmegaPalette = sprite_add("mods/palettes/monsters/omega.png", 1, false, false, 0, 0)
if file_exists("mods/palettes/monsters/queen.png")
    QueenPalette = sprite_add("mods/palettes/monsters/queen.png", 1, false, false, 0, 0)
if file_exists("mods/palettes/monsters/zeta_blur.png")
    ZetaBlur = sprite_add("mods/palettes/monsters/zeta_blur.png", 1, false, false, sprite_get_xoffset(sMZetaBlur), sprite_get_yoffset(sMZetaBlur))
if file_exists("mods/palettes/monsters/queen_dead.png")
    QueenDead = background_add("mods/palettes/monsters/queen_dead.png", 0, 0)
if file_exists("mods/palettes/monsters/queen_blood_drop.png")
    QueenBloodDrop = sprite_add("mods/palettes/monsters/queen_blood_drop.png", sprite_get_number(sQueenBloodDrop), false, false, sprite_get_xoffset(sQueenBloodDrop), sprite_get_yoffset(sQueenBloodDrop))
if file_exists("mods/palettes/monsters/queen_blood_particle.png")
    QueenBloodParticle = sprite_add("mods/palettes/monsters/queen_blood_particle.png", sprite_get_number(sQueenBloodParticle), false, false, sprite_get_xoffset(sQueenBloodParticle), sprite_get_yoffset(sQueenBloodParticle))
