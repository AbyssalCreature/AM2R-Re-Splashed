...
ds_list_add(list_locations, 52, 53, 54, 55, 56, 57, 60, 100, 101, 102, 104, 105, 106, 107, 109, 111, 150, 151, 152, 153, 154, 155, 156, 159, 161, 163)
ds_list_add(list_locations, 202, 203, 204, 205, 208, 210, 211, 214, 250, 252, 255, 257, 259, 303, 304, 307, 308, 309)
ds_list_add(list_locations, 51, 110, 162, 207, 209, 215, 256, 300, 305)
ds_list_add(list_locations, 50, 103, 108, 157, 158, 200, 201, 251, 306)
if (oControl.mod_insanitymode == 0)
    ds_list_add(list_locations, 254)
if (randpb == 0)
    ds_list_add(list_locations, 58, 59, 112, 160, 212, 213, 258, 301, 302)
...
if (randpb == 2)
{
    ds_list_add(list_locations, 59, 112, 160, 212, 213, 258, 301, 302)
    ds_list_shuffle(list_locations)
}
