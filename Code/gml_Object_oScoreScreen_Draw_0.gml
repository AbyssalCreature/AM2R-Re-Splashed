if (state == 0)
{
    ...
    else if oControl.msr_fusionsuit
    {
        ...
        {
            if (saxmode && (!sax) && icebeam)
                draw_background(bgScoreScreenPlayer_fusion_omega2D, playerx, playery)
            else
                draw_background(bgScoreScreenPlayer_fusion2D, playerx, playery)
        }
        else
            draw_background(bgScoreScreenPlayer2D, playerx, playery)
    }
