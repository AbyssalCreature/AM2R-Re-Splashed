...
ini_write_real("Extras", "UIStyle", oControl.hudoption)
ini_write_real("Extras", "UIColor", oControl.guicolor)
ini_write_real("Extras", "UIGame", oControl.gamehud)
ini_write_real("Extras", "Multitroid Palette", oControl.palette)
ini_write_real("Extras", "Multitroid Suit", oControl.preferredcolor)
...
ini_write_string("Multiworld", "SlotName", global.slotName)
ini_write_string("Multiworld", "SlotPass", global.slotPass)
ini_close()
