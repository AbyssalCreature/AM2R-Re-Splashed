...
while (filename != "")
{
    if (string_pos(string_lower(string_replace(get_text("Header", "Language"), " (16:9)", "")), string_lower(filename)) != 0)
    {
        ...
        var hframes = string_pos("_f", string_lower(filename));
        var hd1 = string_pos("_b", string_lower(filename));
        var hd2 = string_pos("_c", string_lower(filename));
        var hd3 = string_pos("_d", string_lower(filename));
        var hd4 = string_pos("_e", string_lower(filename));
...
file_find_close();
filename = file_find_first("lang/titles/*.png", 0);
...
while (filename != "")
{
    if (string_pos(string_lower(string_replace(get_text("Header", "Language"), " (16:9)", "")), string_lower(filename)) != 0)
    {
        ...
        var titley = string_pos("y", string_lower(filename));
...
file_find_close();
filename = file_find_first("*.png", 0);
...
while (filename != "")
{
    if (string_pos("titlebackground", filename) != 0)
    {
        ...
        var bgspeed = string_pos("s", string_lower(filename));
...
var col = surface_getpixel_ext(surf, 0, 0);
