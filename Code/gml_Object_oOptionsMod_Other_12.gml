...
else if (oControl.palette == 2)
{
    switch oControl.preferredcolor
    {
        ...
        case 2:
            ...
            break
        case 3:
            op[num_color].optext = "Mystical"
            break
        case 4:
            op[num_color].optext = "The Horde"
            break
        case 5:
            op[num_color].optext = "ssanoo"
            break
        case 6:
            op[num_color].optext = "Lucina"
            break
        case 7:
        ...
        case 9:
            ...
            break
        case 10:
            op[num_color].optext = "DruidVorse"
            break
        case 11:
            op[num_color].optext = "Alex87"
            break
        case 12:
        ...
        case 14:
            ...
            break
        case 15:
            op[num_color].optext = "Kragondor"
            break
        case 16:
            op[num_color].optext = "Steele"
            break
        case 17:
            op[num_color].optext = "Random"
            break
...
{
    case 0:
        op[num_palette].optext = "Dark"
        break
    case 1:
        op[num_palette].optext = "Resplashed"
        break
    case 2:
