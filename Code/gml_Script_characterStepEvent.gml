var jump_vel, splash, statetimelessthan2, statetimelessthan4, expl, deb, touhoucount, touhoudir, touhouxpos, touhouypos, ziptimer, prevzipx, liquid, filter, firebuttons;
