        ...
        if inview
        {
            ...
            else
            {
                ...
                if (sprite_index == sSkorpBody)
                {
                    ...
                    {
                        draw_sprite_pixelated(sSkorpDiscLunge_Fusion, 0, (lastEnemyX + (lengthdir_x(11, (lastAngle - 24)))), (lastEnemyY + (lengthdir_y(11, (lastAngle - 24)))), -1, 1, 0, c_white, 1, sizeX, sizeY, 32)
                        draw_sprite_pixelated(sSkorpDiscLunge_Fusion, 0, (lastEnemyX + (lengthdir_x(11, (lastAngle + 24)))), (lastEnemyY + (lengthdir_y(11, (lastAngle + 24)))), 1, 1, 0, c_white, 1, sizeX, sizeY, 32)
                    }
                    else
                    {
