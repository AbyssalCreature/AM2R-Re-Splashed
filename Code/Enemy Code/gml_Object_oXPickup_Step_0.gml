...
if (state == 0)
{
    ...
    if (sprite_index == sRamulken || sprite_index == sRamulken_Fusion)
    {
        sprite_index = sRamulkenNoShield;
        
        if (oControl.mod_fusion)
            sprite_index = sRamulkenNoShield_Fusion;
    }
    
    if (lastEnemy == 295 || lastEnemy == 838 || lastEnemy == 837 || lastEnemy == 308 || lastEnemy == 326 || lastEnemy == 348 || lastEnemy == 863 || lastEnemy == 636 || lastEnemy == 354 || lastEnemy == 841)
        reform = -1;
}
...
if (state == 4)
{
    ...
    if (statetime == 0)
    {
        if (lastEnemy != 342 && lastEnemy != 355)
            lastAngle = 0;
