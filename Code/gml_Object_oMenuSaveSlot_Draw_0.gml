...
if (saveexists)
{
    ...
    draw_cool_text(x + tioffset, y + 3 + oControl.GUIOffset, timestring, 0, fontcolor, fontcolor, 1);
    draw_set_font(global.fontGUI2);
    draw_set_halign(fa_right);
    draw_cool_text(x + proffset, y + 2, string(sprogress) + "%", 0, fontcolor, fontcolor, 1);
...
var rgb_green = make_color_rgb(8, 253, 142);
var rgb_darkgreen = make_color_rgb(1, 24, 25);
var rgb_medgreen = make_color_rgb(1, 142, 81);
rgb_gray = make_colour_rgb(82, 89, 102);

if (global.saveslot != slot && saveexists)
{
    if (smode == 3 || smode == 4 || smode == 5)
        draw_cool_text(x + 4, y + 20, string(modeindex) + sseed, oControl.paletteDarkGreen, oControl.paletteMedGreen, oControl.paletteMedGreen, 1);
}
else if (global.saveslot == slot && saveexists)
{
    if (smode == 3 || smode == 4 || smode == 5)
        draw_cool_text(x + 4, y + 20, string(modeindex) + sseed, oControl.paletteDarkGreen, oControl.paletteBrightGreen, oControl.paletteBrightGreen, 1);
}
